/*
 * a network application example based on inet SCTP socket
 * https://docs.oracle.com/cd/E19253-01/817-4415/sockets-85885/index.html
 *   In a one-to-many style, each socket handles multiple SCTP associations.
...
int sctp_opt_info(int sock, sctp_assoc_id_t id,
                  int opt, void *arg, socklen_t *len);

ssize_t sctp_recvmsg(int s, void *msg, size_t len,
